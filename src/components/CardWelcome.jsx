...
const CardWelcome = ({ item }) => {
    return (
        <View className='flex-1 justify-center items-center w-screen sm:bottom-12'>
            <View className='w-screen sm:h-96 items-center'>
                <View className='sm:w-[80%] sm:h-80 lg:w-[620px] lg:h-[620px] sm:mb-3 lg:bottom-16 rounded-full items-center justify-center'>
            ...
            <View className='sm:top-2 lg:bottom-2'>
                ...
                <Text className='sm:top-12 sm:w-[377px] lg:w-[700px] sm:text-[23px] lg:text-4xl font-normal text-center dark:text-white'>{item.description}</Text>
            </View>
        </View>
    )
}
