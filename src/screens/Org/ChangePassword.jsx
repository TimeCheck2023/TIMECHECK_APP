...
import { auth, cambioPassword, cambioPasswordOrg } from "../../api/api";
...
const ChangePassword = ({ navigation }) => {
    ...
    const validateForm = async () => {
        ...
        if (contraseñaNueva !== contraseñaNuevaCon) {
        ...
        }else if(contraseñaNueva === '' || contraseñaActual === '' || contraseñaNuevaCon === ''){
            return setErrors("Tienes que ingresar todos los campos");
        } else {
            const data = {
                contraseñaActual,
                contraseñaNueva,
            ...
            try {
                setIsLoading(true)
                const result = await cambioPasswordOrg(data)
