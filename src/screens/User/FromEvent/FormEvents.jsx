import { StyleSheet, Text, View, Image, TouchableOpacity, KeyboardAvoidingView, ScrollView, Platform, TextInput } from 'react-native'
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.containerSend}>
                <TouchableOpacity style={styles.send} onPress={handleSelectImage}>
